...
public class GuiModSettings extends GuiListScreen {
    public GuiModSettings(Screen lastScreen) {
        super(Component.translatable("vivecraft.options.screen.mod"), lastScreen);
    }
    ...
    protected List<SettingsList.BaseEntry> getEntries() {
        ...
        entries.add(SettingsList.vrOptionToEntry(VRSettings.VrOptions.VR_HOTSWITCH));
        ...
        entries.add(new SettingsList.CategoryEntry(Component.literal("Server")));
        entries.add(new SettingsList.WidgetEntry(
            Component.translatable("vivecraft.options.screen.server"),
            Button.builder(Component.translatable("vivecraft.options.screen.server.button"), button -> this.minecraft.setScreen(new GuiServerSettings(this)))
